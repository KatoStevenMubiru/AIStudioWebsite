      ...
      <main className="flex-1">
        <div className="container px-4 py-12 md:px-6 mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-[#333333]">Join Our Team</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Help us build Uganda's sovereign AI future. We're looking for talented individuals to join our team.
            </p>
          </div>

          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-md p-8 mb-8">
              <h2 className="text-2xl font-bold mb-4 text-[#333333]">Why Join Uganda AI Studio?</h2>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <div className="h-6 w-6 rounded-full bg-[#159b8d] text-white flex items-center justify-center mr-3 mt-0.5">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                  ...
                  <span>Work on cutting-edge AI technology with real-world impact</span>
                </li>
                <li className="flex items-start">
                  <div className="h-6 w-6 rounded-full bg-[#159b8d] text-white flex items-center justify-center mr-3 mt-0.5">
                    <svg
                  ...
                  <span>Contribute to Uganda's technological sovereignty</span>
                </li>
                <li className="flex items-start">
                  <div className="h-6 w-6 rounded-full bg-[#159b8d] text-white flex items-center justify-center mr-3 mt-0.5">
                    <svg
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <h2 className="text-2xl font-bold mb-6 text-[#333333]">Open Positions</h2>

              <div className="space-y-6">
                <div className="border-b pb-6">
                  <h3 className="text-xl font-bold text-[#333333]">AI Research Engineer</h3>
                  <p className="text-[#159b8d] font-medium">Full-time • Kampala, Uganda</p>
                  <p className="text-gray-600 mt-2">
                    We're looking for AI Research Engineers to help develop and improve our AI models.
                  </p>
                  <button className="mt-4 bg-[#159b8d] hover:bg-[#128a7d] text-white px-4 py-2 rounded-md">
                    Apply Now
                  </button>
                </div>

                <div className="border-b pb-6">
                  <h3 className="text-xl font-bold text-[#333333]">Machine Learning Engineer</h3>
                  <p className="text-[#159b8d] font-medium">Full-time • Kampala, Uganda</p>
                  <p className="text-gray-600 mt-2">
                    Join our team to build and deploy machine learning models at scale.
                  </p>
                  <button className="mt-4 bg-[#159b8d] hover:bg-[#128a7d] text-white px-4 py-2 rounded-md">
                    Apply Now
                  </button>
                ...
                <div className="border-b pb-6">
                  <h3 className="text-xl font-bold text-[#333333]">Full Stack Developer</h3>
                  <p className="text-[#159b8d] font-medium">Full-time • Kampala, Uganda</p>
                  <p className="text-gray-600 mt-2">Help us build the next generation of AI-powered applications.</p>
                  <button className="mt-4 bg-[#159b8d] hover:bg-[#128a7d] text-white px-4 py-2 rounded-md">
                    Apply Now
                  </button>
                </div>
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#333333]">Product Manager</h3>
                  <p className="text-[#159b8d] font-medium">Full-time • Kampala, Uganda</p>
                  <p className="text-gray-600 mt-2">Drive the vision and strategy for our AI products.</p>
                  <button className="mt-4 bg-[#159b8d] hover:bg-[#128a7d] text-white px-4 py-2 rounded-md">
                    Apply Now
                  </button>
                </div>
